...
import { initFontPreferences } from '@/components/settings/FontStylePicker';

// Apply saved font preferences immediately
initFontPreferences();
  ...
  return (
    <Routes>
      <Route element={<AppLayout />}>
        ...
        <Route path="/social/club/:id" element={<ClubDetail />} />
      </Route>
